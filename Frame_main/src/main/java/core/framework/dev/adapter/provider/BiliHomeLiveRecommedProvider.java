...
public class BiliHomeLiveRecommedProvider implements ItemViewProvider<LiveInfo.DataBean.RecommendDataBean.BannerDataBean> {
    ...
    @Override
    public void bindItemData(ViewHolder holder, LiveInfo.DataBean.RecommendDataBean.BannerDataBean itemData, int position) {
        holder.setText(R.id.tv_user_name, itemData.getOwner().getName())
                .setText(R.id.tv_watch_num, String.valueOf(itemData.getOnline()))
                .setImageViewUrl(FrameApp.getContext(), R.id.iv_content, itemData.getCover().getSrc());
    ...
    @Override
    public void onClick(View view, RecyclerView.ViewHolder holder, LiveInfo.DataBean.RecommendDataBean.BannerDataBean itemData, int position) {
        VideoPlayerCenterActivity.launch((Activity) view.getContext(), itemData.getPlayurl(), itemData.getArea_id());
    }

    @Override
    public boolean onLongClick(View view, RecyclerView.ViewHolder holder, LiveInfo.DataBean.RecommendDataBean.BannerDataBean itemData, int position) {
        return false;
    }
}
