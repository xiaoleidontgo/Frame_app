 ...
 * 视频评论
 */
public class LiveVideoFeedbackFragment extends SingleSwipeRefreshListFragment<Integer> {

    public static LiveVideoFeedbackFragment newInstance(int area_id) {
        Bundle args = new Bundle();
        args.putInt("area_id", area_id);
        LiveVideoFeedbackFragment fragment = new LiveVideoFeedbackFragment();
